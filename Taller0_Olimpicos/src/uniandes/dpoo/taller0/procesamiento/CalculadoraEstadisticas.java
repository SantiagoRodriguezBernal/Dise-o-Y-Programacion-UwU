...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna un diccionario con el nombre del atleta y su pais.
	 * 
	 * @return  un diccionario con el nombre del atleta y su pais asociado.
	 */
	public String atletaPais(String nombreAtleta)
	{
		Atleta NombreAtleta = buscarAtleta(nombreAtleta);
		String paisrespuesta = ("No se encontro respuesta");
		if (NombreAtleta == null)
		{
			System.out.println("No se encontro el atleta ingresado.");
		}
		else
		{
			paisrespuesta = (NombreAtleta.darPais().darNombre());
		}
