...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("0. Consultar pais de Atleta");
	...
	/**
	 * Le pide al usuario el nombre de un atleta y luego le muestra la informacion del
	 * pais del atleta indicado.
	 */
	private void ejecutarBuscarPais()
	{
		...
		String nombreAtleta = calculadora.atletaPais(nombre);
		...
		{
			System.out.println("El atleta pertenece al pais de " + nombreAtleta);
		}
	}
